var AnimationLayer = cc.Layer.extend({
    ...
    win:function(){
        ...
        // write
        obj.others.savedStep = savedStep;
        obj.others.savedTimeLeft = savedTimeLeft;
        str = JSON.stringify(obj);
        cc.sys.localStorage.setItem("userData",str);
        cc.log("update:"+JSON.stringify(obj.power));

        this.getParent().addChild(new PhraseLayer(), 5, TagOfLayer.Phrase);    //Tag4        
        this.getParent().choice(1);
        this.getParent().getChildByTag(TagOfLayer.Status).removeFromParent();
    ...
    lose:function(){    //save?
        ...
        if(savedStep == 0){
            if(cc.sys.os === cc.sys.OS_ANDROID){
                this.labelSavedStep = new cc.LabelTTF("なし", "res/font/logotypejp_mp_b_1.ttf", 30);
            } else {
                this.labelSavedStep = new cc.LabelTTF("なし", "Corporate-Logo-Bold", 30);
            }
            ...
            if(cc.sys.os === cc.sys.OS_ANDROID){
                this.labelSavedStep = new cc.LabelTTF("あと " + savedStep + " Step!!", "res/font/logotypejp_mp_b_1.ttf", 30);
                this.labelSavedTime = new cc.LabelTTF("あと "+ savedTimeLeft + "Sec.", "res/font/logotypejp_mp_b_1.ttf", 30);                
            } else {
                this.labelSavedStep = new cc.LabelTTF("あと " + savedStep + " Step!!", "Corporate-Logo-Bold", 30);
                this.labelSavedTime = new cc.LabelTTF("あと "+ savedTimeLeft + "Sec.", "Corporate-Logo-Bold", 30);
            }
            this.labelSavedStep.setColor(cc.color(0,0,0));//black color
            this.labelSavedStep.setPosition(cc.p(w/4, h*0.65));
        ...
        if(record[0] == null){
            ...
            if(cc.sys.os === cc.sys.OS_ANDROID){
                this.labelProgress = new cc.LabelTTF("あと " + record[0] + " Step!!", "res/font/logotypejp_mp_b_1.ttf", 30);
                this.labelTime = new cc.LabelTTF("あと "+ record[1] + " Sec.", "res/font/logotypejp_mp_b_1.ttf", 30);
            } else {
                this.labelProgress = new cc.LabelTTF("あと " + record[0] + " Step!!", "Corporate-Logo-Bold", 30);
                this.labelTime = new cc.LabelTTF("あと "+ record[1] + " Sec.", "Corporate-Logo-Bold", 30);
            }
            this.labelProgress.setColor(cc.color(0,0,0));//black color
            this.labelProgress.setPosition(cc.p(w*3/4, h*0.65));
            ...
            saveMenu.alignItemsVerticallyWithPadding(180);
    ...
    cancel:function(){  // IAP, AdColonyのProcessing状態でもbuttonがenabledされてしまうが・・（isProcessingフラグとupdate()で処理する？
