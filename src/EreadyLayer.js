var EreadyLayer = cc.Layer.extend({
    labelSavedStep:null,
    labelSavedTime:null,
    ...
    init:function () {
        ...
        var introbg = new cc.Sprite(res.Timeattack_png);
        ...
        goMenu.setPosition(cc.p(w/2,70+goBtn.height/2));  // originally h/8
    ...
    reference : function(){
        if(isShowReference == 1){
            ...
            if(cc.sys.os === cc.sys.OS_ANDROID){
                this.labelSavedStep = new cc.LabelTTF("あと　50 Step!!", "res/font/logotypejp_mp_b_1.ttf", 40);
                this.labelSavedTime = new cc.LabelTTF(savedTimePassing + " Sec.", "res/font/logotypejp_mp_b_1.ttf", 40);
            } else {
                this.labelSavedStep = new cc.LabelTTF("あと　50 Step!!", "Corporate-Logo-Bold", 40);
                this.labelSavedTime = new cc.LabelTTF(savedTimePassing + " Sec.", "Corporate-Logo-Bold", 40);
            }
    ...
    dustbox : function(){
        // save clear
        savedTimePassing = 0;
        this.labelSavedStep.setString("あと　100 Step!!");
        this.labelSavedTime.setString("0 Sec.");
