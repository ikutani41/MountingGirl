var CountdownLayer = cc.Layer.extend({
    ...
    cdstart:function(){
        ...
        var displayStep = 0;
        if(savedTimeLeft == 0){
            displayTime = timeLimits[lv-1];
            displayStep = goalSteps[lv-1];
        } else {
            displayTime = savedTimeLeft;
            displayStep = savedStep;
        }            

        if(cc.sys.os === cc.sys.OS_ANDROID){
            this.labelStatement1 = new cc.LabelTTF("制限時間 "+displayTime+"秒以内に", "res/font/logotypejp_mp_b_1.ttf", 40);
            this.labelStatement2 = new cc.LabelTTF(displayStep+"タップを狙え！", "res/font/logotypejp_mp_b_1.ttf", 40);
        } else {
            this.labelStatement1 = new cc.LabelTTF("制限時間 "+displayTime+"秒以内に", "Corporate-Logo-Bold", 40);
            this.labelStatement2 = new cc.LabelTTF(displayStep+"タップを狙え！", "Corporate-Logo-Bold", 40);
        }
